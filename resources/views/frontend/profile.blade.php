    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
            ...
            <div class="p-6 md:p-8 relative">
                <!-- Profile Photo -->
                <div class="absolute -top-16 left-8 w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-md">
                ...
                <div class="mt-12 md:mt-0 md:ml-36 flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="mt-4 md:mt-0 flex gap-3">
                        <a href="#" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm transition-colors">
                            <span class="material-symbols-outlined text-base mr-1">edit</span> Edit Profile
                        </a>
                        <a href="#" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 text-sm transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="flex border-b border-gray-200">
                <button class="tab-btn px-6 py-4 text-blue-600 border-b-2 border-blue-600 font-medium" onclick="openTab(event, 'personal')">
                    <span class="material-symbols-outlined align-middle mr-1">person</span> Personal Info
                </button>
                <button class="tab-btn px-6 py-4 text-gray-500 hover:text-gray-700 font-medium" onclick="openTab(event, 'activity')">
                    <span class="material-symbols-outlined align-middle mr-1">history</span> Activity
                </button>
                <button class="tab-btn px-6 py-4 text-gray-500 hover:text-gray-700 font-medium" onclick="openTab(event, 'settings')">
            ...
            <div id="personal" class="tab-content block p-6 md:p-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">101, Green Street, Andheri West, Mumbai, Maharashtra - 400053</p>
                                </div>
                            </div>
                ...
                <div class="mt-8">
                    ...
                    <p class="text-gray-600 mb-4">
                        Frontend developer with 5+ years of experience in creating responsive and user-friendly web applications. Passionate about UI/UX design and modern web technologies.
                    </p>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    <div class="flex justify-between items-center pb-4 border-b border-gray-200">
                        ...
                        <label class="relative inline-block w-12 h-6">
                            ...
                            <span class="slider absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-blue-600 rounded-full">
                                <span class="absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform duration-200 ease-in-out transform translate-x-6"></span>
                            </span>
                        </label>
                    </div>
                    
                    <div class="pt-2">
                        <button class="w-full md:w-auto px-6 py-3 bg-red-100 text-red-600 hover:bg-red-200 rounded-lg font-medium transition-colors">
                            <span class="material-symbols-outlined align-middle mr-1">logout</span> Sign Out of All Devices
                        </button>
                    </div>
                </div>
            </div>
