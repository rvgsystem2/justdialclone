...
@section('content')
    ...
    <section class="bg-white py-6 px-4 lg:px-10">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Heading -->
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">Popular <span
                    class="text-blue-600">Jewellery</span> Showrooms in Mumbai</h1>
            ...
            <div class="grid lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border p-4 flex gap-4">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <h2 class="font-semibold text-lg text-gray-800">Meghna Jewellers Pvt Ltd</h2>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
                                <div class="flex items-center gap-1 text-green-600 font-semibold">
                                    <span class="material-symbols-outlined text-base text-yellow-500">star</span> 3.8★
                                </div>
                                <span>88 Ratings</span>
                                <span class="text-blue-600 flex items-center gap-1">
                                    <span class="material-symbols-outlined text-base">verified</span> Verified
                                </span>
                                <span class="flex items-center gap-1">
                                    <span class="material-symbols-outlined text-base text-orange-400">bolt</span> Responsive
                                </span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <a href="tel:08105909723"
                                    class="bg-green-600 text-white px-4 py-1 rounded text-sm flex items-center gap-1">
                                    <span class="material-symbols-outlined text-base">call</span> 08105909723
                                </a>
                                <a href="#"
                                    class="bg-green-100 text-green-800 px-3 py-1 rounded text-sm flex items-center gap-1">
                                ...
                                <a href="#"
                                    ...
                                    <span class="material-symbols-outlined text-base">rocket_launch</span> Get Best Deal
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border p-4 flex gap-4">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <h2 class="font-semibold text-lg text-gray-800">Shree Aabhushan Jewellers</h2>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
                                <div class="flex items-center gap-1 text-green-600 font-semibold">
                                    <span class="material-symbols-outlined text-base text-yellow-500">star</span> 4.3★
                                </div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <a href="tel:08105900000"
                                    class="bg-green-600 text-white px-4 py-1 rounded text-sm flex items-center gap-1">
                                    <span class="material-symbols-outlined text-base">call</span> 08105900000
                                </a>
                                <a href="#"
                                    class="bg-green-100 text-green-800 px-3 py-1 rounded text-sm flex items-center gap-1">
                                    <span class="material-symbols-outlined text-base">chat</span> WhatsApp
