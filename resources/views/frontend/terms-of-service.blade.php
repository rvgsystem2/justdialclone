...
@section('content')
    <section class="max-w-5xl mx-auto py-16 px-6 lg:px-0 text-gray-800">
        <div class="mb-12 text-center">
            <h1 class="text-4xl font-bold mb-4 text-gray-900">Terms of Service</h1>
        ...
        <div class="space-y-10 text-base leading-relaxed">
            <!-- Term 1 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">1. Acceptance of Terms</h2>
            ...
            <!-- Term 2 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">2. Use of Services</h2>
                <p class="text-gray-700">
            ...
            <!-- Term 3 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">3. Account Responsibility</h2>
                <p class="text-gray-700">
            ...
            <!-- Term 4 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">4. Prohibited Conduct</h2>
            ...
            <!-- Term 5 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">5. Termination</h2>
                <p class="text-gray-700">
            ...
            <!-- Term 6 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">6. Limitation of Liability</h2>
                <p class="text-gray-700">
            ...
            <!-- Term 7 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">7. Governing Law</h2>
                <p class="text-gray-700">
            ...
            <!-- Term 8 -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 mb-2">8. Changes to the Terms</h2>
                <p class="text-gray-700">
        ...
        <div class="mt-16 border-t pt-6 text-center">
            <p class="text-gray-600">
                ...
                <a href="{{ route('contact') }}" class="text-blue-600 hover:underline font-medium">contact us</a>.
            </p>
        </div>
    </section>
@endsection
