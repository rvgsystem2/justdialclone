...
@section('content')
    <section class="max-w-5xl mx-auto py-16 px-4 text-gray-800">
        <h1 class="text-4xl font-bold mb-6 text-amber-600 text-center">Cookie Policy</h1>

        <p class="mb-6 text-lg text-center max-w-3xl mx-auto">
            This Cookie Policy explains how we use cookies and similar technologies to recognize you when
            you visit our website. It explains what these technologies are and why we use them, as well as your rights to
            control our use of them.
        </p>

        <h2 class="text-2xl font-semibold mt-10 mb-4 text-amber-600">1. What are cookies?</h2>
        ...
        <h2 class="text-2xl font-semibold mt-10 mb-4 text-amber-600">2. Why do we use cookies?</h2>
        ...
        <h2 class="text-2xl font-semibold mt-10 mb-4 text-amber-600">3. Types of cookies we use</h2>
        ...
        <h2 class="text-2xl font-semibold mt-10 mb-4 text-amber-600">4. How can you control cookies?</h2>
        ...
        <h2 class="text-2xl font-semibold mt-10 mb-4 text-amber-600">5. Changes to this Cookie Policy</h2>
